...
function UpdateEntityFace(Ped, Table)
    ...
    if (Table ~= nil) then
        SetPedHeadBlendData(Ped, Table.parent.mom -1, Table.parent.dad -1, nil, Table.parent.mom -1, Table.parent.dad -1, nil, Table.parent.resemblance / 10, Table.parent.skinMix / 10, nil, true)
